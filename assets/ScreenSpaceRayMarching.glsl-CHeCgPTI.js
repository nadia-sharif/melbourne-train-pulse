import{n as e,t}from"./glsl-D85RBwKC.js";import{t as n}from"./FloatBindUniform-C4h6J6-v.js";import{t as r}from"./Matrix4BindUniform-DnHs9Hq_.js";import{t as i}from"./Texture2DBindUniform-4_yYNByJ.js";import{t as a}from"./Float2BindUniform-C6b2PHzh.js";import{t as o}from"./ReadDepth.glsl-Ca_0z8Pl.js";function s(s,c){let l=s.fragment;l.include(o),l.uniforms.add(new a(`nearFar`,e=>e.camera.nearFar),new i(`depthMap`,e=>e.depth?.attachment),new r(`proj`,e=>e.camera.projectionMatrix),new n(`invResolutionHeight`,e=>1/e.camera.height),new r(`reprojectionMatrix`,e=>e.reprojection.matrix)).code.add(e`
  ...
  vec3 screenSpaceIntersectionWithLimits(
    ...
    for(int stepIndex = 0; stepIndex < rayMarchMaxStepsInt - 1; ++stepIndex) {
      ...
      ${t(!c.clampRayToScreen,`if (projectedPosition.x <= 0.0  || projectedPosition.x >= 1.0) {
        return vec3(projectedPosition, 0.0);
      }`)}
      ...
      ${t(c.clampRayToScreen,`projectedPosition = clamp(projectedPosition, vec2(0.0), vec2(0.999));`)}
    }
    return vec3(projectedPosition, 0.0);
  }
  ...
  vec3 screenSpaceIntersection(vec3 rayDirection, vec3 startPosition, vec3 viewDirection, vec3 normal, float rayStepOffset) {
    return screenSpaceIntersectionWithLimits(
      ...
      normal,
      rayStepOffset,
      ${e.float(c.rayMarchMaxReach)},
      ${e.float(c.rayMarchMaxSteps)}
    );
  }
  `)}export{s as t};