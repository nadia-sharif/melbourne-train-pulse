import{n as e}from"./glsl-D85RBwKC.js";import{t}from"./Texture2DPassUniform-CiCHIiok.js";import{t as n}from"./ScreenSpacePass.glsl-9L-_X5OK.js";import{t as r}from"./ShaderBuilder-8uuwgR05.js";var i=.05,a=2;function o(){let o=new r;return o.include(n),o.outputs.add(`fragEdges`,`vec2`),o.fragment.code.add(e`float absMax3(vec3 v) {
vec3 t = abs(v);
return max(max(t.r, t.g), t.b);
}`),o.fragment.uniforms.add(new t(`colorTexture`,e=>e.color)).main.add(e`
    ...
    vec2 edges = step(vec2(${e.float(i)}), delta);
    ...
    if (dot(edges, vec2(1.0)) == 0.0) {
      ...
      fragEdges = edges * step(maxDelta, float(${e.float(a)}) * delta);
    }
