import{l as e}from"./vec3f64-DIOQknMY.js";import{r as t,t as n}from"./mat4f64-E_FXCKxO.js";import{C as r,y as i}from"./mat4-i5hbKyBt.js";import{t as a}from"./NoParameters-XZJ-8n06.js";import{t as o}from"./Float3PassUniform-YEiGS05C.js";import{n as s}from"./glsl-D85RBwKC.js";import{t as c}from"./Matrix4BindUniform-DnHs9Hq_.js";import{t as l}from"./FloatPassUniform-DeUP8HjM.js";import{t as u}from"./Texture2DBindUniform-4_yYNByJ.js";import{t as d}from"./ReadDepth.glsl-Ca_0z8Pl.js";import{t as f}from"./FloatsPassUniform-DfJ8EJ1F.js";import{t as p}from"./Float2PassUniform-BYZ61_RB.js";import{t as m}from"./IntegerPassUniform-DN8CxRD1.js";import{t as h}from"./Texture2DPassUniform-CiCHIiok.js";import{t as g}from"./ScreenSpacePass.glsl-9L-_X5OK.js";import{t as _}from"./ShaderBuilder-8uuwgR05.js";import{t as v}from"./Matrix4PassUniform-Bb5ATfS6.js";import{t as y}from"./CameraSpace.glsl-LQZFWYSr.js";import{t as b}from"./PiUtils.glsl-CpyVHJCx.js";import{t as x}from"./Matrix4sPassUniform-BCkM81Sa.js";var S=class extends a{constructor(){super(...arguments),this.localOrigin=e()}};function C(e){e.include(y),e.fragment.uniforms.add(new v(`inverseViewMatrix`,(e,t)=>{let a=r(n(),t.camera.viewMatrix,e.localOrigin);return i(a,a)})).code.add(s`vec4 reconstructLocalPosition(vec2 coord, float linearDepth) {
vec4 cameraSpace = vec4(reconstructPosition(coord, linearDepth), 1.0);
return inverseViewMatrix * cameraSpace;
}`)}var w=class extends S{constructor(){super(...arguments),this.shadowMap={depthTexture:null,nearFar:[1,100],numActiveFaces:1,atlasRegions:[[0,0,1,1]]},this.targetVector=[1,0,0],this.upVector=[0,0,1],this.fovs=[45,45],this.headingAndTilt=[0,0],this.observerOffset=[0,0,0],this.projectionMatrices=t.flat(),this.viewMatrices=t.flat(),this.volumeOffset=0}};function T(){let e=new _,t=e.fragment;return e.include(g),e.include(C),t.include(d),t.include(b),t.uniforms.add(new c(`inverseProjectionMatrix`,e=>e.camera.inverseProjectionMatrix),new c(`inverseViewNormalMatrix`,({camera:e})=>i(E,e.viewInverseTransposeMatrix)),new o(`viewshedObserverOffset`,e=>e.observerOffset),new o(`viewshedTargetVector`,e=>e.targetVector),new o(`viewshedUpVector`,e=>e.upVector),new p(`viewshedFOVs`,e=>e.fovs),new p(`viewshedHeadingAndTilt`,e=>e.headingAndTilt),new p(`viewshedNearFar`,e=>e.shadowMap.nearFar??[1,100]),new l(`viewshedVolumeOffset`,e=>e.volumeOffset),new h(`viewshedShadowMap`,e=>e.shadowMap.depthTexture),new x(`viewshedProjectionMatrices`,e=>e.projectionMatrices,6),new x(`viewshedViewMatrices`,e=>e.viewMatrices,6),new m(`viewshedNumFaces`,e=>e.shadowMap.numActiveFaces),new f(`viewshedAtlasRegions`,24,e=>e.shadowMap.atlasRegions.flat()),new u(`depthTexture`,e=>e.mainDepth),new h(`normalMap`,e=>e.normals)),t.constants.add(`visibleColor`,`vec4`,[0,1,0,.5]),t.constants.add(`occludedColor`,`vec4`,[1,0,0,.5]),t.code.add(s`vec2 getViewshedUv(vec4 worldPosition, int face) {
...
}`),t.main.add(s`float depth = depthFromTexture(depthTexture, uv);
